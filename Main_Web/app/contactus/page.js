...
export default function ContactUs() {
  ...
  // Animation effect for header elements
  useEffect(() => {
    setIsVisible(true);
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.file) {
        formSubmitData.append("attachment", formData.file);
      }
  ...
  return (
    <>
      <Head>
        <title>Contact Us - FitOn</title>
        <meta
          name="description"
          content="Contact FitOn for any questions or support. We're here to help with your virtual fitting needs."
        />
      </Head>
          ...
          <div className={styles.contactForm}>
            <div className={styles.formWrapper}>
              ...
              <form onSubmit={handleSubmit} encType="multipart/form-data">
                {/* Hidden Formspree fields for better email organization */}
                <input
                  type="hidden"
                  name="_subject"
                ...
                <div className={styles.formGroup}>
                  ...
                  >
                    ...
                    <option value="Retail Partnership">
                      Retail Partnership
                    </option>
