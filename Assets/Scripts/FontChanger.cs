...
public class FontChanger : MonoBehaviour
{
    ...
    public GameObject Login_form; // Reference to Login_form GameObject
    ...
    {
        // Validate references
        if (Starter == null || Login_form == null || Phrase == null)
        {
    ...
    void Update()
    {
        ...
        if (Login_form.activeInHierarchy && !Starter.activeInHierarchy)
        {
            if (!isAnimating)
            {
                isAnimating = true;
    ...
    {
        while (Login_form.activeInHierarchy)
        {
